...
// Serve static content using this server for now-
...
// Serving my extra static content-
// app.use(express.static(__dirname + "/media"));
// app.use(express.static("../Dowo storage/media"));
app.use("/static", express.static("../../../MasherStorage"));
