...
function MessagingScreenCustomHeader({
  userId,
  name,
  imageUrl,
  isGroup,
...
// isOnline,
{
  ...
  console.log('Messagingscreen custom header')
  ...
  useEffect(() => {
    if (selectedMessageIds.length === 0) {
      console.log('selected message ids cleared')
  ...
  setIsOnline(checkIsUserOnline(userId, onlineUsers));
  }
            ...
            >
              ...
              <View style={{ marginHorizontal: 10 }}>
                ...
                {isOnline ? (
                  ...
                  >
                    <TabBarIcon name="circle" size={8} color="lightgreen" />{" "}
                    Online
                  </Text>
                ) : (
                  lastSeen !== "" && (
