...
export default function NativeAdCardSettings() {
  ...
  <NativeAdView nativeAd={nativeAd}>
    ...
    minWidth: 0, }}>
      ...
      {/* Ad Attribution */}
        ...
        <NativeAsset assetType={NativeAssetType.HEADLINE}>
          <Text style={{ fontSize: 13, fontWeight: '600', marginVertical: 5, color: '#FFFFFF', width: '100%', textAlign: 'center', paddingTop: 10,  }}>
           {nativeAd.headline}
          </Text>
        </NativeAsset>
      {/* CTA */}
      ...
      <NativeAsset assetType={NativeAssetType.BODY}>
           ...
           <Text style={{ fontSize: 11, marginVertical: 5, color: '#FFFFFF', width: '100%', textAlign: 'center', paddingTop: 10, paddingHorizontal: 10 }}>
           {nativeAd.body}
          </Text>
      </NativeAsset>
      </View>
